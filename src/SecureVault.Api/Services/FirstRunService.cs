...
/// The MEK and JWT signing key MUST be pre-generated by the operator and mounted
/// (typically as Docker secrets) before the application starts — they are loaded
...
public class FirstRunService
{
        ...
        CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            // INSTALL.md before the first `docker compose up`.
